...
const Categories = () => {
  return (
    <div className='w-full bg-[#F0FB7] py-24'>
        <div className='md: max-w-[1480px] m-auto max-w-[600px]'>
            <h1 className='md: leading-[72px] text-3x1 font-bold'>Most <span className='text-[#20B486]'>Popular Categories</span></h1>
            <p className='text-lg text-gray-600'>Varioous versions have evolved over the years, sometimes by accident. </p>
       
            <div className='grid lg:grid-cols-4 grid-colos-2 py-12 md:gap-4 gap-1'>
                ...
                < CategoryCard icons={<AiOutlineCamera size={30} />} title= {'Development'} />
